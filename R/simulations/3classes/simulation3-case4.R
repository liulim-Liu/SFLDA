...
simulation3.case4 <- function(){
  ...
  for (k in 1:1){
    ...
    #write.csv(df0, paste("simulation_n300_p100.10_t40_c3_tp7.3.csv", sep = ""), row.names=FALSE)

  }


  #data <- read.csv("simulation_n300_p100.10_t40_c3_tp7.3.csv")
  #View(data)
  data <- df0
  ...
  #write.csv(train.df, "train_simulation_n300_p100.10_t40_c3_tp7.3.csv", row.names=FALSE)
  #write.csv(test.df, "test_simulation_n300_p100.10_t40_c3_tp7.3.csv", row.names=FALSE)
