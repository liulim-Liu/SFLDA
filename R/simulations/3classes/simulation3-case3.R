...
simulation3.case3 <- function(){
  ...
  for (k in 1:1){
   ...
   # write.csv(df0, paste("simulation_n300_p100.10_t40_c3_tp6.2.csv", sep = ""), row.names=FALSE)

  }

  #data <- read.csv("simulation_n300_p100.10_t40_c3_tp6.2.csv")
  #View(data)
  data <- df0
