...
simulation2.case3 <- function(){
  ...
  for (k in 1:1){
    ...
    #write.csv(df0, paste("simulation_n200_p100.10_t40_c2_tp6.2.csv", sep = ""), row.names=FALSE)

  }

  #data <- read.csv("simulation_n200_p100.10_t40_c2_tp6.2.csv")
  #View(data)
  data <- df0
  ...
  #write.csv(train.df, "train_simulation_n200_p100.10_t40_c2_tp6.2.csv", row.names=FALSE)
  #write.csv(test.df, "test_simulation_n200_p100.10_t40_c2_tp6.2.csv", row.names=FALSE)
